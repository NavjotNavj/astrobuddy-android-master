...
/**
 * Created by sonu on 23:26, 26/04/18
...
public class SmartTextView extends AppCompatTextView {
    ...
    private void initialize(AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            if (attrArray != null) {
                mJustified = attrArray.getBoolean(R.styleable.SmartTextView_justified_, false);
                mFontType = FontType.values()[attrArray.getInt(R.styleable.SmartTextView_font_, 1)];
