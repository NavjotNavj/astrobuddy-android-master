...
/**
 * Created by sonu on 15:15, 11/04/19
 * Copyright (c) 2019 . All rights reserved.
 */
public class MatchMakingDetailModel {
    private final AppCompatActivity appCompatActivity;
    private final APIInterface apiInterface;

    public MatchMakingDetailModel(AppCompatActivity appCompatActivity, APIInterface apiInterface) {
