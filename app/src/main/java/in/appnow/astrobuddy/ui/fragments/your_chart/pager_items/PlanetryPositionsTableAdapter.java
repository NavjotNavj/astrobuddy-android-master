...
import in.appnow.astrobuddy.models.RowHeader;
import in.appnow.astrobuddy.utils.Logger;

/**
 * Created by sonu on 18:24, 05/07/18
 * Copyright (c) 2018 . All rights reserved.
 */
public class PlanetryPositionsTableAdapter extends AbstractTableAdapter<ColumnHeader, RowHeader, Cell> {

    private Context context;

    public PlanetryPositionsTableAdapter(Context context) {
        super(context);
    ...
    class MyCellViewHolder extends AbstractViewHolder {
        ...
        public MyCellViewHolder(View itemView) {
            super(itemView);
            cell_textview = (TextView) itemView.findViewById(R.id.table_view_cell_label);
        }
    }
    ...
    public void onBindCellViewHolder(AbstractViewHolder holder, Object cellItemModel, int
        ...
        if (TextUtils.isEmpty(cell.getLabel())) {
            viewHolder.cell_textview.setText("-");
        } else {
            viewHolder.cell_textview.setText(cell.getLabel());
        }
    ...
    class MyColumnHeaderViewHolder extends AbstractViewHolder {
        ...
        public MyColumnHeaderViewHolder(View itemView) {
            super(itemView);
            column_header_textview = (TextView) itemView.findViewById(R.id.table_view_header_label);
        }
    }
    ...
    public void onBindColumnHeaderViewHolder(AbstractViewHolder holder, Object columnHeaderItemModel, int
        ...
        columnHeaderViewHolder.column_header_textview.setText(columnHeader.getLabel());
